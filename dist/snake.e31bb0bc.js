...
},{"./_baseClone":"node_modules/lodash/_baseClone.js"}],"node_modules/ms/index.js":[function(require,module,exports) {
/**
 * Helpers.
 */
...
},{"./common":"node_modules/debug/src/common.js","process":"node_modules/process/browser.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var debug = (0, _debug.default)('snake');
localStorage.debug = '*';
var squareWidth = 14;
...
function createArea(_ref2) {
  ...
  function drawSnake(body) {
    body.forEach(function (part, index) {
      drawRectangle(part.x * squareWidth, part.y * squareWidth, "rgba(255,255,255, 0.7)");
    });
  }

  function drawApples(apples) {
    apples.forEach(function (apple) {
      drawRectangle(apple.x * squareWidth, apple.y * squareWidth, "rgba(255,0,0, 0.7)");
    });
  }
...
function createKeyboardController() {
  ...
  return {
    onClick: function onClick(key, handler) {
...
function createElement(name) {
  var element = document.querySelector("#js-".concat(name));
...
},{"lodash/cloneDeep":"node_modules/lodash/cloneDeep.js","debug":"node_modules/debug/src/browser.js"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
